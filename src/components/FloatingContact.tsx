...
const LINKS = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 32 32" fill="currentColor" className="h-6 w-6 drop-shadow-[0_1px_1px_rgba(0,0,0,0.25)]">
        <path d="M16 3c4.6 0 7.4 3.5 7.4 8.1 0 .8-.1 1.6-.2 2.4.4.2.9.3 1.4.3.7-.1 1.4-.4 1.9-.7.3-.2.7-.1.9.2.2.3.1.7-.2.9-.7.5-1.6.8-2.5.9-.3 0-.6 0-.9-.1.3.7.7 1.4 1.3 2 .9.9 2 1.6 3.2 2 .3.1.5.4.4.8-.2 1-1.7 1.7-4 2-.1.3-.2.7-.3 1-.1.3-.4.5-.7.4-.6-.1-1.2-.2-1.9-.2-1 0-1.7.2-2.6.9-.9.7-1.8 1.4-3.2 1.4s-2.3-.7-3.2-1.4c-.9-.6-1.6-.9-2.6-.9-.7 0-1.3.1-1.9.2-.3.1-.6-.1-.7-.4-.1-.3-.2-.7-.3-1-2.3-.3-3.8-1-4-2-.1-.4.1-.7.4-.8 1.2-.4 2.3-1.1 3.2-2 .6-.6 1-1.3 1.3-2-.3.1-.6.1-.9.1-.9-.1-1.8-.4-2.5-.9-.3-.2-.4-.6-.2-.9.2-.3.6-.4.9-.2.5.3 1.2.6 1.9.7.5 0 1-.1 1.4-.3-.1-.8-.2-1.6-.2-2.4C8.6 6.5 11.4 3 16 3z"/>
      </svg>
    ),
  },
];
