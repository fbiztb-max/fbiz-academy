    ...
    <div className="min-h-screen bg-background py-10 px-4" dir="rtl">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="surface-card p-8">
          ...
          <p>تلتزم منصة ProEdge بحماية خصوصية مستخدميها وفق نظام حماية البيانات الشخصية في المملكة العربية السعودية (PDPL)، ولوائح حماية البيانات في الإمارات والكويت وقطر والبحرين وعُمان ومصر والأردن وسائر الدول العربية، ومعايير اللائحة الأوروبية (GDPR) كحدّ أعلى.</p>
