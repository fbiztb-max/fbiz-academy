    ...
    <div className="min-h-screen bg-background py-10 px-4" dir="rtl">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="surface-card p-8 prose prose-invert max-w-none">
          ...
          <p>باستخدامك منصة ProEdge للتدريب التنفيذي، فإنك توافق على الالتزام بهذه الشروط وجميع الأنظمة والقوانين السارية في بلدك من الدول العربية، بما فيها أنظمة المعاملات الإلكترونية، حماية البيانات الشخصية، ومكافحة الجرائم المعلوماتية.</p>
          ...
          <p>جميع المحتويات (الفيديوهات، النصوص، الشعارات، التصاميم) ملك حصري لمنصة ProEdge، ومحمية بقوانين الملكية الفكرية في الدول العربية والاتفاقيات الدولية. يُمنع نسخ أو إعادة نشر أو بيع المحتوى بأي شكل دون إذن خطي مسبق.</p>
